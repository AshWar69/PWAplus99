            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            2022 © Store99.{{-- <script>document.write(new Date().getFullYear())</script>  --}}
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Design & Develop with <i class="text-danger ri-heart-2-fill"></i> by <a href="https://thedevbros.com" target="_blank" class="text-red">DevBros</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{asset('js/bootstrap-tree.js')}}"></script>
