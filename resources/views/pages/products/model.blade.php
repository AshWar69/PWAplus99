            ...
            <form class="row g-3 needs-validation" id="compForm" method="POST" enctype="multipart/form-data" novalidate>
                ...
                <div class="col-md-6">
                    ...
                    <div class="invalid-feedback">
                        Please Fill Up Model Name
                    </div>
                </div>
                <div class="col-md-6">
                    <label for="validationCustom01" class="form-label">Model Warranty</label>
                    <input type="text" class="form-control" name="mwarrant">
                    <div class="valid-feedback">
                        Looks good!
                    </div>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <label for="validationCustom01" class="form-label">Model Image</label>
                    <input type="file" class="form-control" id="validationCustom03" name="img" required>
                    <div class="valid-feedback">
                        Looks good!
                    </div>
                    <div class="invalid-feedback">
                        Please Upload Product Model Image
                    </div>
                </div>
                <div class="col-12">
