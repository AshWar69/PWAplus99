    ...
    (e = function () {
        ...
        var u = function (t) {
            ...
            h = function (t, e) {
                ...
                (e.feedback = { query: t, matches: i, results: s }),
                    f("results", e);
            },
            m = "aria-expanded",
            ...
            g = function (t) {
                t.isOpen ||
                    ((t.wrapper || t.input).setAttribute(m, !0),
            ...
            w = function (t) {
                t.isOpen &&
                    ((t.wrapper || t.input).setAttribute(m, !1),
            ...
            L = function (t, e, n) {
                (n = n >= 0 ? n : t.cursor) < 0 ||
                    ((t.feedback.event = e), v(t, n), f("selection", t), w(t));
            };
        function j(t, n) {
            var r = this;
            return new Promise(function (i, o) {
                ...
                return (
                    (s =
                        n ||
                        ((u = t.input) instanceof HTMLInputElement ||
                ...
                if (
                    ...
                    t.wrapper &&
                        (t.wrapper = a(
                            "div",
                            e(
                                { around: t.input, class: t.name + "_wrapper" },
                                u
                            )
                        )),
                    s &&
